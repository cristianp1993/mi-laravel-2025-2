                    ...
                    <div class="p-6">
                        <div class="mb-6">
                            ...
                            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div v-if="event.event_image" class="md:col-span-2">
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Event Image</p>
                                    <img :src="'/storage/' + event.event_image" alt="Event Image" class="mt-1 w-full max-w-md h-auto rounded-md shadow-sm">
                                </div>
                            </div>
                        </div>
                    </div>
