...
onMounted(() => {
    ...
    if (props.event.event_date) {
        ...
        form.event_date = `${year}-${month}-${day}T${hours}:${minutes}`;
    }
});
</script>
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2 flex space-x-4">
                                    <div v-if="props.event.event_image && !imagePreview" class="flex flex-col">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            />
                                            <InputLabel for="remove_image" value="Remove current image" class="ml-2 dark:text-gray-300"/>
                                        </div>
                                    </div>
                                    <div v-if="imagePreview" class="flex flex-col">
                                        <p class="text-sm text-gray-600 dark:text-gray-400">New Image Preview:</p>
                                        <img :src="imagePreview" alt="New Image Preview" class="w-32 h-32 object-cover rounded-md border">
                                    </div>
                                </div>
                            </div>
